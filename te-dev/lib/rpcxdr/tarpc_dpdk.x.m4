...
enum tarpc_pktmbuf_ol_flags {
    TARPC_RTE_MBUF_F_RX_VLAN = 0,
    TARPC_RTE_MBUF_F_RX_VLAN_STRIPPED,
    TARPC_RTE_MBUF_F_RX_RSS_HASH,
    TARPC_RTE_MBUF_F_RX_FDIR,
    TARPC_RTE_MBUF_F_RX_IP_CKSUM_BIT0,
    TARPC_RTE_MBUF_F_RX_IP_CKSUM_BIT1,
    TARPC_RTE_MBUF_F_RX_L4_CKSUM_BIT0,
    TARPC_RTE_MBUF_F_RX_L4_CKSUM_BIT1,
    TARPC_RTE_MBUF_F_RX_OUTER_IP_CKSUM_BAD,
    TARPC_RTE_MBUF_F_RX_OVERSIZE,
    TARPC_RTE_MBUF_F_RX_HBUF_OVERFLOW,
    TARPC_RTE_MBUF_F_RX_RECIP_ERR,
    TARPC_RTE_MBUF_F_RX_MAC_ERR,
    TARPC_RTE_MBUF_F_RX_IEEE1588_PTP,
    TARPC_RTE_MBUF_F_RX_IEEE1588_TMST,
    TARPC_RTE_MBUF_F_RX_FDIR_ID,
    TARPC_RTE_MBUF_F_RX_FDIR_FLX,
    TARPC_RTE_MBUF_F_RX_QINQ,
    TARPC_RTE_MBUF_F_RX_QINQ_STRIPPED,

    TARPC_RTE_MBUF_F_TX_QINQ = 32,
    TARPC_RTE_MBUF_F_TX_TCP_SEG,
    TARPC_RTE_MBUF_F_TX_IEEE1588_TMST,
    TARPC_RTE_MBUF_F_TX_L4_NO_CKSUM,
    TARPC_RTE_MBUF_F_TX_TCP_CKSUM,
    TARPC_RTE_MBUF_F_TX_SCTP_CKSUM,
    TARPC_RTE_MBUF_F_TX_UDP_CKSUM,
    TARPC_RTE_MBUF_F_TX_L4_MASK,
    TARPC_RTE_MBUF_F_TX_IP_CKSUM,
    TARPC_RTE_MBUF_F_TX_IPV4,
    TARPC_RTE_MBUF_F_TX_IPV6,
    TARPC_RTE_MBUF_F_TX_VLAN,
    TARPC_RTE_MBUF_F_TX_OUTER_IP_CKSUM,
    TARPC_RTE_MBUF_F_TX_OUTER_IPV4,
    TARPC_RTE_MBUF_F_TX_OUTER_IPV6,
    TARPC_RTE_MBUF_F_TX_OUTER_UDP_CKSUM,

    TARPC_RTE_MBUF_F_TX_TUNNEL_VXLAN,
    TARPC_RTE_MBUF_F_TX_TUNNEL_GENEVE,
    TARPC_RTE_MBUF_F_TX_TUNNEL_GRE,

    TARPC_RTE_MBUF_F_INDIRECT = 50,
    TARPC_RTE_MBUF_F_EXTERNAL,

    TARPC_RTE_MBUF_F__UNKNOWN = 63
};
...
enum tarpc_eth_link_speeds {
    TARPC_RTE_ETH_LINK_SPEED_FIXED_BIT = 0,
    TARPC_RTE_ETH_LINK_SPEED_10M_HD_BIT,
    TARPC_RTE_ETH_LINK_SPEED_10M_BIT,
    TARPC_RTE_ETH_LINK_SPEED_100M_HD_BIT,
    TARPC_RTE_ETH_LINK_SPEED_100M_BIT,
    TARPC_RTE_ETH_LINK_SPEED_1G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_2_5G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_5G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_10G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_20G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_25G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_40G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_50G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_56G_BIT,
    TARPC_RTE_ETH_LINK_SPEED_100G_BIT,
...
enum tarpc_dev_rx_offload_bits {
    TARPC_RTE_ETH_RX_OFFLOAD_VLAN_STRIP_BIT = 0,
    TARPC_RTE_ETH_RX_OFFLOAD_IPV4_CKSUM_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_UDP_CKSUM_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_TCP_CKSUM_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_TCP_LRO_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_QINQ_STRIP_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_OUTER_IPV4_CKSUM_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_MACSEC_STRIP_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_HEADER_SPLIT_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_VLAN_FILTER_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_VLAN_EXTEND_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_JUMBO_FRAME_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_CRC_STRIP_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_SCATTER_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_TIMESTAMP_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_SECURITY_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_KEEP_CRC_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_SCTP_CKSUM_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_OUTER_UDP_CKSUM_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_RSS_HASH_BIT,
    TARPC_RTE_ETH_RX_OFFLOAD_BUFFER_SPLIT_BIT,
...
enum tarpc_dev_tx_offload_bits {
    TARPC_RTE_ETH_TX_OFFLOAD_VLAN_INSERT_BIT = 0,
    TARPC_RTE_ETH_TX_OFFLOAD_IPV4_CKSUM_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_UDP_CKSUM_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_TCP_CKSUM_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_SCTP_CKSUM_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_TCP_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_UDP_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_OUTER_IPV4_CKSUM_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_QINQ_INSERT_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_VXLAN_TNL_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_GRE_TNL_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_IPIP_TNL_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_GENEVE_TNL_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_MACSEC_INSERT_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_MT_LOCKFREE_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_MULTI_SEGS_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_MBUF_FAST_FREE_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_SECURITY_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_UDP_TNL_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_IP_TNL_TSO_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_OUTER_UDP_CKSUM_BIT,
    TARPC_RTE_ETH_TX_OFFLOAD_SEND_ON_TIMESTAMP_BIT,
...
enum tarpc_rte_eth_rss_types {
    TARPC_RTE_ETH_RSS_IPV4 = 0,
    TARPC_RTE_ETH_RSS_FRAG_IPV4,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV4_TCP,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV4_UDP,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV4_SCTP,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV4_OTHER,
    TARPC_RTE_ETH_RSS_IPV6,
    TARPC_RTE_ETH_RSS_FRAG_IPV6,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV6_TCP,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV6_UDP,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV6_SCTP,
    TARPC_RTE_ETH_RSS_NONFRAG_IPV6_OTHER,
    TARPC_RTE_ETH_RSS_L2_PAYLOAD,
    TARPC_RTE_ETH_RSS_IPV6_EX,
    TARPC_RTE_ETH_RSS_IPV6_TCP_EX,
    TARPC_RTE_ETH_RSS_IPV6_UDP_EX,
    TARPC_RTE_ETH_RSS_PORT,
    TARPC_RTE_ETH_RSS_VXLAN,
    TARPC_RTE_ETH_RSS_GENEVE,
    TARPC_RTE_ETH_RSS_NVGRE,
    TARPC_RTE_ETH_RSS_GTPU,
    TARPC_RTE_ETH_RSS_ETH,
    TARPC_RTE_ETH_RSS_S_VLAN,
    TARPC_RTE_ETH_RSS_C_VLAN,
    TARPC_RTE_ETH_RSS_ESP,
    TARPC_RTE_ETH_RSS_AH,
    TARPC_RTE_ETH_RSS_L2TPV3,
    TARPC_RTE_ETH_RSS_PFCP,
    TARPC_RTE_ETH_RSS_PPPOE,
    TARPC_RTE_ETH_RSS_ECPRI,
    TARPC_RTE_ETH_RSS_MPLS,
    TARPC_RTE_ETH_RSS_IPV4_CHKSUM,
    TARPC_RTE_ETH_RSS_L4_CHKSUM,
    TARPC_RTE_ETH_RSS_L2TPV2,

    TARPC_RTE_ETH_RSS_L3_SRC_ONLY,
    TARPC_RTE_ETH_RSS_L3_DST_ONLY,
    TARPC_RTE_ETH_RSS_L4_SRC_ONLY,
    TARPC_RTE_ETH_RSS_L4_DST_ONLY,
    TARPC_RTE_ETH_RSS_L2_SRC_ONLY,
    TARPC_RTE_ETH_RSS_L2_DST_ONLY,

    TARPC_RTE_ETH_RSS_L3_PRE32,
    TARPC_RTE_ETH_RSS_L3_PRE40,
    TARPC_RTE_ETH_RSS_L3_PRE48,
    TARPC_RTE_ETH_RSS_L3_PRE56,
    TARPC_RTE_ETH_RSS_L3_PRE64,
    TARPC_RTE_ETH_RSS_L3_PRE96,

    TARPC_RTE_ETH_RSS_LEVEL_OUTERMOST,
    TARPC_RTE_ETH_RSS_LEVEL_INNERMOST,
...
enum tarpc_rte_flow_error_type {
    ...
    TARPC_RTE_FLOW_ERROR_TYPE_ATTR_TRANSFER,
    TARPC_RTE_FLOW_ERROR_TYPE_ATTR,
    TARPC_RTE_FLOW_ERROR_TYPE_ITEM_NUM,
    TARPC_RTE_FLOW_ERROR_TYPE_ITEM_SPEC,
    TARPC_RTE_FLOW_ERROR_TYPE_ITEM_LAST,
    TARPC_RTE_FLOW_ERROR_TYPE_ITEM_MASK,
    TARPC_RTE_FLOW_ERROR_TYPE_ITEM,
    TARPC_RTE_FLOW_ERROR_TYPE_ACTION_NUM,
    TARPC_RTE_FLOW_ERROR_TYPE_ACTION_CONF,
