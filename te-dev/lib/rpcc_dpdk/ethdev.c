                           ...
                           const struct tarpc_rte_eth_dev_info *dev_info)
{
    ...
    te_log_buf_append(tlbp, ", nb_rx_queues=%u", dev_info->nb_rx_queues);
    te_log_buf_append(tlbp, ", nb_tx_queues=%u", dev_info->nb_tx_queues);
...
#define TARPC_RSS_HASH_PROTO2STR(_proto)                                     \
    ...
    TARPC_RSS_HASH_PROTO2STR(GTPU);
    TARPC_RSS_HASH_PROTO2STR(ETH);
    TARPC_RSS_HASH_PROTO2STR(S_VLAN);
    TARPC_RSS_HASH_PROTO2STR(C_VLAN);
    TARPC_RSS_HASH_PROTO2STR(ESP);
    TARPC_RSS_HASH_PROTO2STR(AH);
    TARPC_RSS_HASH_PROTO2STR(L2TPV3);
    TARPC_RSS_HASH_PROTO2STR(PFCP);
    TARPC_RSS_HASH_PROTO2STR(PPPOE);
    TARPC_RSS_HASH_PROTO2STR(ECPRI);
    TARPC_RSS_HASH_PROTO2STR(MPLS);
    TARPC_RSS_HASH_PROTO2STR(IPV4_CHKSUM);
    TARPC_RSS_HASH_PROTO2STR(L4_CHKSUM);
    TARPC_RSS_HASH_PROTO2STR(L2TPV2);

    TARPC_RSS_HASH_PROTO2STR(L3_SRC_ONLY);
    TARPC_RSS_HASH_PROTO2STR(L3_DST_ONLY);
    TARPC_RSS_HASH_PROTO2STR(L4_SRC_ONLY);
    TARPC_RSS_HASH_PROTO2STR(L4_DST_ONLY);
    TARPC_RSS_HASH_PROTO2STR(L2_SRC_ONLY);
    TARPC_RSS_HASH_PROTO2STR(L2_DST_ONLY);

    TARPC_RSS_HASH_PROTO2STR(L3_PRE32);
    TARPC_RSS_HASH_PROTO2STR(L3_PRE40);
    TARPC_RSS_HASH_PROTO2STR(L3_PRE48);
    TARPC_RSS_HASH_PROTO2STR(L3_PRE56);
    TARPC_RSS_HASH_PROTO2STR(L3_PRE64);
    TARPC_RSS_HASH_PROTO2STR(L3_PRE96);

    TARPC_RSS_HASH_PROTO2STR(LEVEL_OUTERMOST);
    TARPC_RSS_HASH_PROTO2STR(LEVEL_INNERMOST);
