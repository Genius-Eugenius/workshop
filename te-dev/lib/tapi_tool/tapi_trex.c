...
#define TAPI_TREX_OPT_FLT_ERR(_name, _descr) \
    {.name = _name, .descr = "\\*" _descr }
...
static const tapi_trex_opt_flt_descr opt_filters[] = {
    ...
    TAPI_TREX_OPT_FLT("tcps_closed", "conn. closed (includes drops)"),
    TAPI_TREX_OPT_FLT("tcps_segstimed", "segs where we tried to get rtt"),
    TAPI_TREX_OPT_FLT("tcps_rttupdated", "times we succeeded"),
    TAPI_TREX_OPT_FLT("tcps_delack", "delayed acks sent"),
    TAPI_TREX_OPT_FLT("tcps_sndtotal", "total packets sent"),
    TAPI_TREX_OPT_FLT("tcps_sndpack", "data packets sent"),
    TAPI_TREX_OPT_FLT("tcps_sndbyte", "data bytes sent by application"),
    TAPI_TREX_OPT_FLT("tcps_sndbyte_ok", "data bytes sent by tcp"),
    TAPI_TREX_OPT_FLT("tcps_sndctrl", "control (SYN|FIN|RST) packets sent"),
    TAPI_TREX_OPT_FLT("tcps_sndacks", "ack-only packets sent"),
    TAPI_TREX_OPT_FLT("tcps_rcvtotal", "total packets received"),
    TAPI_TREX_OPT_FLT("tcps_rcvpack", "packets received in sequence"),
    TAPI_TREX_OPT_FLT("tcps_rcvbyte", "bytes received in sequence"),
    TAPI_TREX_OPT_FLT("tcps_rcvackpack", "rcvd ack packets"),
    TAPI_TREX_OPT_FLT("tcps_rcvackbyte", "tx bytes acked by rcvd acks"),
    TAPI_TREX_OPT_FLT("tcps_rcvackbyte_of",
            "tx bytes acked by rcvd acks - overflow acked"),
    TAPI_TREX_OPT_FLT("tcps_rcvoffloads",
            "receive offload packets by software"),

    TAPI_TREX_OPT_FLT("tcps_preddat", "times hdr predict ok for data pkts"),

    TAPI_TREX_OPT_FLT("tcps_drops", "connections dropped"),
    TAPI_TREX_OPT_FLT_ERR("tcps_conndrops", "embryonic connections dropped"),
    TAPI_TREX_OPT_FLT_ERR("tcps_timeoutdrop", "conn. dropped in rxmt timeout"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rexmttimeo", "retransmit timeouts"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rexmttimeo_syn", "retransmit SYN timeouts"),
    TAPI_TREX_OPT_FLT_ERR("tcps_persisttimeo", "persist timeouts"),
    TAPI_TREX_OPT_FLT_ERR("tcps_keeptimeo", "keepalive timeouts"),
    TAPI_TREX_OPT_FLT_ERR("tcps_keepprobe", "keepalive probes sent"),
    TAPI_TREX_OPT_FLT_ERR("tcps_keepdrops", "connections dropped in keepalive"),
    TAPI_TREX_OPT_FLT("tcps_testdrops",
            "connections dropped by user at timeout (no-close flag --nc)"),

    TAPI_TREX_OPT_FLT_ERR("tcps_sndrexmitpack", "data packets retransmitted"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sndrexmitbyte", "data bytes retransmitted"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sndprobe", "window probes sent"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sndurg", "packets sent with URG only"),
    TAPI_TREX_OPT_FLT("tcps_sndwinup", "window update-only packets sent"),

    TAPI_TREX_OPT_FLT_ERR("tcps_rcvbadsum",
            "packets received with ccksum errs"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvbadoff", "packets received with bad offset"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvshort", "packets received too short"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvduppack", "duplicate-only packets received"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvdupbyte", "duplicate-only bytes received"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvpartduppack",
            "packets with some duplicate data"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvpartdupbyte",
            "dup. bytes in part-dup. packets"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvoopackdrop",
            "OOO packet drop due to queue len"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvoobytesdrop",
            "OOO bytes drop due to queue len"),

    TAPI_TREX_OPT_FLT_ERR("tcps_rcvoopack", "out-of-order packets received"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvoobyte", "out-of-order bytes received"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvpackafterwin",
            "packets with data after window"),

    TAPI_TREX_OPT_FLT_ERR("tcps_rcvbyteafterwin", "bytes rcvd after window"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvafterclose", "packets rcvd after close"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvwinprobe", "rcvd window probe packets"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvdupack", "rcvd duplicate acks"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvacktoomuch", "rcvd acks for unsent data"),
    TAPI_TREX_OPT_FLT_ERR("tcps_rcvwinupd", "rcvd window update packets"),
    TAPI_TREX_OPT_FLT_ERR("tcps_pawsdrop", "segments dropped due to PAWS"),
    TAPI_TREX_OPT_FLT("tcps_predack", "times hdr predict ok for acks"),
    TAPI_TREX_OPT_FLT_ERR("tcps_persistdrop", "timeout in persist state"),
    TAPI_TREX_OPT_FLT_ERR("tcps_badsyn", "bogus SYN e.g. premature ACK"),

    TAPI_TREX_OPT_FLT_ERR("tcps_reasalloc", "allocate tcp reasembly ctx"),
    TAPI_TREX_OPT_FLT_ERR("tcps_reasfree", "free tcp reasembly ctx"),
    TAPI_TREX_OPT_FLT_ERR("tcps_reas_hist_4", "count of max queue <= 4"),
    TAPI_TREX_OPT_FLT_ERR("tcps_reas_hist_16", "count of max queue <= 16"),
    TAPI_TREX_OPT_FLT_ERR("tcps_reas_hist_100", "count of max queue <= 100"),
    TAPI_TREX_OPT_FLT_ERR("tcps_reas_hist_other", "count of max queue > 100"),
    TAPI_TREX_OPT_FLT_ERR("tcps_nombuf", "no mbuf for tcp - drop the packets"),

    TAPI_TREX_OPT_FLT_ERR("tcps_sack_recovery_episode",
            "SACK recovery episodes"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sack_rexmits", "SACK rexmit segments"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sack_rexmit_bytes", "SACK rexmit bytes"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sack_rcv_blocks",
            "SACK blocks (options) received"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sack_send_blocks",
            "SACK blocks (options) sent"),
    TAPI_TREX_OPT_FLT_ERR("tcps_sack_sboverflow",
            "times scoreboard overflowed"),

    TAPI_TREX_OPT_FLT("tcps_ecn_ce", "ECN Congestion Experienced"),
    TAPI_TREX_OPT_FLT("tcps_ecn_ect0", "ECN Capable Transport"),
