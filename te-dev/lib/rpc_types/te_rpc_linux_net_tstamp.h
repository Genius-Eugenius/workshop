...
#define HWTSTAMP_INSTR_MAPPING_LIST \
    ...
    RPC_BIT_MAP_ENTRY(SOF_TIMESTAMPING_OPT_STATS), \
    RPC_BIT_MAP_ENTRY(SOF_TIMESTAMPING_OPT_PKTINFO), \
    RPC_BIT_MAP_ENTRY(SOF_TIMESTAMPING_OPT_TX_SWHW), \
    RPC_BIT_MAP_ENTRY(SOF_TIMESTAMPING_BIND_PHC), \
    RPC_BIT_MAP_ENTRY(SOF_TIMESTAMPING_OPT_ID_TCP), \
